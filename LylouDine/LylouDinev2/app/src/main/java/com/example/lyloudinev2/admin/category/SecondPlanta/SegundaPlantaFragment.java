...
public class SegundaPlantaFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_segunda_planta, container, false);
        ...
        addMesaButton.setOnClickListener(v -> {
            mesaDAO.addMesa("Nueva Mesa", "Segunda Planta", R.drawable.ic_mesa); // Agregar la mesa con el ícono
        ...
        removeMesaButton.setOnClickListener(v -> {
            List<Mesa> mesas = mesaDAO.getMesas("Segunda Planta");
            if (!mesas.isEmpty()) {
